...
[_QWERTY] = {
  ...
  {KC_LCTL,  KC_LALT, KC_LGUI, FN,      LOWER,   /*SPACE_FN*/KC_SPC,KC_BSPC, RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT}
},
 ...
 */
[_NEO] = {
  {KC_ESC,  KC_X,    KC_V,    KC_L,    KC_C,    KC_W,    KC_K,    KC_H,    KC_G,    KC_F,    KC_Q,    KC_DEL},
